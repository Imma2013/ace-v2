...
export const Preview = memo(({ setSelectedElement }: PreviewProps) => {
  ...
  const isPreviewEnvironmentReady = webcontainerContext.loaded;
  const isPreviewBooting = isPreviewEnvironmentReady && previews.length === 0;
  const isPreviewReloading = activePreview !== undefined && !activePreview.ready;
      ...
      <div className="flex-1 border-t border-bolt-elements-borderColor flex justify-center items-center overflow-auto">
        ...
        >
          {activePreview ? (
            <>
              {isPreviewReloading && (
                <div className="absolute inset-0 z-10 flex flex-col items-center justify-center gap-3 bg-bolt-elements-background-depth-1/90 text-bolt-elements-textPrimary">
                  <div className="i-ph:spinner-gap animate-spin text-2xl" />
                  <p className="text-sm">Refreshing app preview...</p>
                </div>
              )}
            ...
            <div className="flex w-full h-full justify-center items-center bg-bolt-elements-background-depth-1 text-bolt-elements-textPrimary">
              <div className="flex flex-col items-center gap-3 text-center px-6">
                <div className="i-ph:spinner-gap animate-spin text-2xl text-bolt-elements-textTertiary" />
                <div className="space-y-1">
                  <p className="text-sm font-medium">
                    {isPreviewBooting ? 'Starting app preview...' : 'Preparing preview environment...'}
                  </p>
                  <p className="text-xs text-bolt-elements-textTertiary">
                    {isPreviewBooting
                      ? 'Your app server is still booting. The preview will appear automatically.'
                      : 'The preview container is still loading.'}
                  </p>
                </div>
              </div>
            </div>
