...
import { Search, RefreshCw, GitBranch, Calendar, Filter, Link as LinkIcon } from 'lucide-react';
...
export function GitHubRepositorySelector({ onClone, className }: GitHubRepositorySelectorProps) {
  ...
  return (
    ...
    >
        ...
        <div>
          ...
          <p className="text-sm text-bolt-elements-textSecondary">
            {isConnected && connection
              ...
              : 'Connect GitHub in settings to browse your account repositories.'}
          </p>
        </div>
        {isConnected && connection && (
          <Button
      ...
      {!isConnected || !connection ? (
        <div className="text-center p-8 rounded-xl border border-dashed border-bolt-elements-borderColor">
          <p className="text-bolt-elements-textSecondary mb-4">
            GitHub account browsing is unavailable until you connect GitHub.
          </p>
